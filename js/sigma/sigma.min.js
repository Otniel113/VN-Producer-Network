...
a.p.inertia*(a.stageY-k)),b.preventDefault?b.preventDefault():b.returnValue=!1)},!0);b.addEventListener("touchstart",g,{passive:!1,capture:!0});b.addEventListener("touchmove",g,{passive:!1,capture:!0});document.addEventListener("touchend",g,{passive:!1,capture:!0});b.addEventListener("touchcancel",g,{passive:!1,capture:!0});this.checkBorders=function(){return a};this.interpolate=f}function z(b,j,f,c,a,g,d){function i(a){var b=c,d="fixed"==h.p.labelSize?h.p.defaultLabelSize:h.p.labelSizeRatio*a.displaySize;b.font=(h.p.hoverFontStyle||h.p.fontStyle||"")+" "+d+"px "+(h.p.hoverFont||
